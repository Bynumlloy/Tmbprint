...
export default async function Home() {
  ...
  const theme = {
    bg: "#DBE3BA",
    cardBg: "#DBE3BA",
    cardBorder: "rgba(255, 255, 255, 0.01)",
    textPrimary: "#050505",
    textMuted: "#0f2535",
    accentGold: "#f59e0b",
    whatsapp: "#10b981",
          ...
          >
            ...
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `linear-gradient(to bottom, rgba(11,15,25,0) 55%, rgba(11,15,25,.6) 80%, ${theme.bg} 100%)`,
              }}
            />
          </div>
              ...
              >
                ...
                >
                  <li style={{ marginBottom: 6 }}>
                    <strong style={{ color: theme.textPrimary }}>Mindset</strong> – Building the right habits: patience, discipline, and long-term focus
                  </li>
                  <li style={{ marginBottom: 6 }}>
                    <strong style={{ color: theme.textPrimary }}>Time</strong> – Leveraging consistency and the power of compounding
                  </li>
                  <li>
                    <strong style={{ color: theme.textPrimary }}>Capital</strong> – Putting your resources to work through diversified strategies and smart decision making
                  </li>
                </ul>
