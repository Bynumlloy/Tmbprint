...
export default async function Home() {
  const { whatsapp: WHATSAPP_URL, telegram: TELEGRAM_URL, whatsappNumber, telegramUsername } = await getLinks();
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                <Link
                  href={WHATSAPP_URL}
                  target="_blank"
                  style={{ width: "100%", background: theme.whatsapp, color: "#fff", padding: "14px 16px", borderRadius: 14, textDecoration: "none", fontWeight: 600, fontSize: 14, display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: "0 4px 16px rgba(37,211,102,0.22)" }}
                >
                ...
                <span style={{ fontSize: 12, color: theme.muted, fontWeight: 500, letterSpacing: 0.3 }}>
                  {whatsappNumber}
                </span>
              </div>
              <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                <Link
                  href={TELEGRAM_URL}
                  target="_blank"
                  style={{ width: "100%", background: theme.telegram, color: "#fff", padding: "14px 16px", borderRadius: 14, textDecoration: "none", fontWeight: 600, fontSize: 14, display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: "0 4px 16px rgba(0,136,204,0.22)" }}
                >
